        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-[320px_1fr] gap-8">
          <aside className="bg-card border border-gold rounded-xl p-6 h-fit">
            <div className="w-32 h-32 rounded-full overflow-hidden bg-muted mx-auto mb-4">
              <img
                src={tropeiro.image || "/placeholder.svg"}
                alt={tropeiro.name}
          ...
          <section>
            <div className="bg-card border border-gold rounded-xl p-6 mb-6">
            ...
            <div className="bg-card border border-gold rounded-xl p-6">
              ...
              {!bulls.length ? (
                <p className="text-muted-foreground">
                  Nenhum touro vinculado a este tropeiro.
                </p>
              ) : (
                <div className="grid md:grid-cols-2 gap-4">
                  {bulls.map((bull) => (
                    <div
                      key={bull.id}
                      className="border border-gold rounded-lg overflow-hidden bg-background"
                    >
                      <div className="h-44">
                        <img
                          src={bull.image || "/placeholder.svg"}
                          alt={bull.name}
                          className="w-full h-full object-cover"
                        />
                      </div>
